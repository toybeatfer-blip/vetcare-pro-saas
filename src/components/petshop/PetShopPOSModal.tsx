          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 flex-1 overflow-hidden">
              ...
              <div className="lg:col-span-5 bg-slate-50/70 p-4 sm:p-5 flex flex-col justify-between overflow-y-auto max-h-[50vh] lg:max-h-[calc(94vh-80px)]">
                ...
                {/* Cart Items List Header with Clear Cart button */}
                <div className="flex items-center justify-between pt-2 pb-1">
                  <span className="text-xs font-black text-slate-800 uppercase flex items-center gap-1.5">
                    ...
                    <span>Conceptos a Cobrar ({cart.length})</span>
                  </span>
                  {cart.length > 0 && (
                    <button
                      type="button"
                      onClick={handleClearCart}
                      className="text-[11px] font-bold text-rose-600 hover:text-rose-800 bg-rose-50 hover:bg-rose-100 px-2 py-0.5 rounded-md flex items-center gap-1 cursor-pointer transition-colors"
                      title="Eliminar todos los productos y conceptos de la venta"
                    >
                      <Trash2 className="w-3 h-3" />
                      <span>Vaciar Venta</span>
                    </button>
                  )}
                </div>
                  ...
                  {cart.length === 0 ? (
                    ...
                    cart.map((item) => (
                      ...
                      >
                        ...
                        {/* Quantity Controls & Delete Item Button */}
                        <div className="flex items-center gap-1.5 shrink-0">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg bg-rose-50 text-rose-600 hover:bg-rose-100 hover:text-rose-700 cursor-pointer ml-1 transition-colors flex items-center gap-1"
                            title="Eliminar este concepto / producto del ticket"
                          >
                            <Trash2 className="w-3.5 h-3.5" />
                            <span className="text-[10px] font-bold hidden sm:inline">Quitar</span>
                          </button>
                        </div>
                      </div>
                    ))
